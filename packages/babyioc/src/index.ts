export type IClassWithArg<TContainer, TInstance> = new (
    arg: TContainer
) => TInstance;

export type IClassWithoutArgs<TInstance> = new () => TInstance;

export type IComponentFunction<TContainer, TInstance> = (
 ...
 */
export const component = <TContainer extends {}, TInstance>(
    componentClass: IComponentClass<TContainer, TInstance>
